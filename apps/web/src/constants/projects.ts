...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Real-time messaging, communities, calls, stories, and AI-assisted conversations.',
    longDescription: 'SK Chat brings direct and group messaging, communities, calling, stories, moderation, and AI tools under the shared SK identity.',
    status: 'Live',
    version: '1.0.0',
    technologies: ['React', 'Express', 'MongoDB', 'Socket.IO'],
    gradient: 'from-indigo-400/30 via-violet-400/20 to-cyan-400/20',
    logo: 'CH',
    metrics: [{ label: 'Identity', value: 'SK Auth' }, { label: 'Messages', value: 'Live' }, { label: 'Calls', value: 'Realtime' }],
    features: ['Direct messaging', 'Communities', 'Voice and video calls', 'AI assistance'],
    roadmap: ['Shared contacts', 'Cross-app notifications', 'Advanced moderation'],
    liveLink: 'https://chat.sk-hub.in'
  },
  {
    id: 'project_sk_mediaflow',
    slug: 'sk-mediaflow',
    name: 'SK MediaFlow',
    category: 'Video',
    description: 'Video publishing, streaming, organizations, creator tools, and AI media workflows.',
    longDescription: 'SK MediaFlow provides secure video upload, delivery, discovery, organizations, creator analytics, and AI-assisted media operations with SK identity.',
    status: 'Live',
    version: '1.0.0',
    technologies: ['React', 'Express', 'Prisma', 'AWS'],
    gradient: 'from-rose-400/30 via-orange-400/20 to-violet-400/20',
    logo: 'MF',
    metrics: [{ label: 'Identity', value: 'SK Auth' }, { label: 'Streaming', value: 'Cloud' }, { label: 'Uploads', value: 'Secure' }],
    features: ['Video publishing', 'Cloud streaming', 'Organizations', 'AI metadata'],
    roadmap: ['Live streaming', 'Creator collaboration', 'Media intelligence'],
    liveLink: 'https://mediaflow.sk-hub.in'
  },
  {
    id: 'project_sk_flips',
    slug: 'sk-flips',
